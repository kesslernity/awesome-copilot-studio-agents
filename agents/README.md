...
> Ready-to-deploy Copilot Studio agents, organised by function. Each page carries the full instruction block, the topics it handles, and its deployment notes.

[← Back to the main collection](../README.md)

---

- [**Advanced**](advanced/): 4 agents
- [**Commercial and Legal**](commercial-legal/): 11 agents
- [**Customer Success**](customer-success/): 3 agents
- [**Data and Analytics**](data-analytics/): 4 agents
- [**Data Privacy**](data-privacy/): 4 agents
- [**ESG**](esg/): 4 agents
- [**Finance**](finance/): 5 agents
- [**HR and People**](hr-people/): 8 agents
- [**Industry**](industry/): 5 agents
- [**IT Ops**](it-ops/): 8 agents
- [**Learning and Development**](learning-development/): 4 agents
- [**Procurement**](procurement/): 4 agents
- [**Productivity**](productivity/): 1 agent
- [**Project Management**](project-management/): 11 agents
- [**Sales**](sales/): 8 agents
- [**Strategy and Executive**](strategy-executive/): 4 agents
- [**Trade Compliance**](trade-compliance/): 4 agents
- [**Writing and Communication**](writing-communication/): 7 agents
